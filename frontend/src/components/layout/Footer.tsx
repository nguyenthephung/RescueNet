/**
 * Footer Component
 * Professional footer with support links, legal info, social media
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-black text-white">RescueNet</h3>
            </div>
            ...
            {/* Emergency Hotline */}
            <div className="flex items-center gap-3 p-3 bg-primary-600/10 border border-primary-600/30 rounded-lg">
              ...
              <div>
                <p className="text-xs text-primary-400 font-semibold uppercase tracking-wider">{t('common.emergency')}</p>
                <p className="text-lg font-black text-primary-500">113</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-neutral-500">
              {t('footer.copyright', { year: currentYear } as any)}
            </p>
