...
public enum ErrorCode {
    ...
    OTP_EXPIRED(1010, "Verification code has expired", HttpStatus.BAD_REQUEST),
    OTP_MAX_ATTEMPTS(1011, "Maximum verification attempts reached", HttpStatus.BAD_REQUEST),
