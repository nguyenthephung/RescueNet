...
public class UserEventPublisher {
    ...
    /**
     * Helper method to safely resolve role name.
     * Defaults to "CITIZEN" if roles are null, empty, or contain null values.
     */
    private String resolveRoleName(User user) {
        ...
        return user.getRoles().stream()
                ...
                .filter(Objects::nonNull)          // bỏ qua tên null
                .findFirst()
                .orElse("CITIZEN");                // fallback
    }
}
